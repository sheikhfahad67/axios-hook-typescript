...
import { http } from '../interceptors/interceptor-json';
/**
 ...
 */
export function useJsonApiInterceptor() {
    var _this = this;
     ...
     * @param {ApiConfig} config - All request configurations
     */
    var apiHandler = useCallback(function (config) { return __awaiter(_this, void 0, void 0, function () {
